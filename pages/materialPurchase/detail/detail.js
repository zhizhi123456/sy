...
Page({
  ...
  addndlink() {
    wx.redirectTo({
      url: "/pages/materialPurchase/newlink/newlink?id=" + this.data.info.ID
    })
  },
  /**
   * 生命周期函数--监听页面加载
  ...
  // 退回上步
  sendback() {
    util.Triggerflow(this, 'return', 'purchasecontact', 'materialPurchase')
  },
  // 提交下步
  putin() {
    util.Triggerflow(this, 'next', 'purchasecontact', 'materialPurchase')
  },
  // 删除
  delete() {
    let that = this;
