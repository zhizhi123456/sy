...
Page({
  ...
  return () {
    wx.redirectTo({
      url: "/pages/cable/detail/detail?id=" + this.data.billid + "&table=c"
    })
  },
...
onConfirm8(e) {
  ...
  confirm() {
    ...
    materials[0].CableQualityCheckId = this.data.billid;
  ...
  linkreturn() {
    wx.redirectTo({
      url: "/pages/cable/detaillink/detaillink?detailid=" + this.data.materials[0].ID
    })
  },
  linkconfirm() {
    // console.log(this.data.materials)
