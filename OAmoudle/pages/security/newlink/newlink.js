...
Page({
  ...
  return () {
    wx.redirectTo({
      url: "/OAmoudle/pages/security/detail/detail?id=" + this.data.billid + "&table=c"
    })
  },
...
onConfirm8(e) {
  ...
  linkreturn() {
    wx.redirectTo({
      url: "/OAmoudle/pages/security/detaillink/detaillink?detailid=" + this.data.materials[0].ID
    })
  },
  linkconfirm() {
    // console.log(this.data.materials)
