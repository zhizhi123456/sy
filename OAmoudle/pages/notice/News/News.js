...
Page({
  ...
  change1(e) {
    ...
    if (e.target.dataset.id) {
      wx.redirectTo({
        url: `/OAmoudle/pages/notice/Newsdetail/Newsdetail?id=${e.target.dataset.id}`
      })
    }
  },
  /**
  ...
  onLoad: function (options) {
    ...
    this.setData({
      ...
      section3: app.globalData.AnnouncementType,
  ...
  // 组合查询
  seachqur() {
    util.qgroupdeliver(qgroupnotice, this)
  },
})