...
Page({
  ...
  return () {
    wx.redirectTo({
      url: "/OAmoudle/pages/maintenance/detail/detail?id=" + this.data.billid + "&table=c"
    })
  },
  getgcode(e) {
  ...
  linkreturn() {
    wx.redirectTo({
      url: "/OAmoudle/pages/maintenance/detaillink/detaillink?detailid=" + this.data.materials[0].ID
    })
  },
  linkconfirm() {
    // console.log(this.data.materials)
